        ...
        if (mTextView != null) {
            if (usable) {
                ...
                if (!mTextView.isClickable()) {
                    ...
                    mTextView.setBackground(context.getResources().getDrawable(R.drawable.news_service_no_radius_app_color_red));
                ...
                if (mTextView.isClickable()) {
                    mTextView.setClickable(usable);
                    mTextView.setBackground(context.getResources().getDrawable(R.drawable.news_service_radius_app_color_gray_no_solid));
                }
